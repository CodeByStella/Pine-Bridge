...
export const ScriptAccount = mongoose.model('ScriptAccount', scriptAccountSchema);
...
// TypeScript types
export type User = mongoose.InferSchemaType<typeof userSchema> & { _id: string };
export type InsertUser = z.infer<typeof insertUserSchema>;
export type Script = mongoose.InferSchemaType<typeof scriptSchema> & { _id: string };
export type InsertScript = z.infer<typeof insertScriptSchema>;
export type TradingAccount = mongoose.InferSchemaType<typeof tradingAccountSchema> & { _id: string };
export type InsertTradingAccount = z.infer<typeof insertTradingAccountSchema>;
export type ScriptAccount = mongoose.InferSchemaType<typeof scriptAccountSchema> & { _id: string };
